...
@section('content')
    <div class="row">
        <div class="col-md-8 offset-2"><!--Se ocupan 8 de las 12 columnas y se desplaza 2 columnas a la derecha-->
            <h1>Perfil</h1>
            <hr>
            <h2>Ordenes</h2>
                        ...
                        <ul class="list-group">
                            @foreach($order->cart->items as $item)<!--se pasan cada uno de los articulos--> 
                                <li class="list-group-item">
                                     <span class="badge badge-dark float-right m-1"> {{$item['price']}}$</span>
